...
export default function ListsFilter({
    ...
    // Default to featured items if no filters are selected
    ...
    return (
        <div className="bg-ct-secondary min-h-screen">
            <div
                ref={stickyRef}
                className="sticky top-0 z-10 bg-ct-secondary/90 backdrop-blur-2xl"
            >
                <div>
                    <Nav />
                    {showFilters && (
                ...
                {!items.length ? null : (
                    <div className="flex flex-wrap -ml-[2px] -mt-[2px] w-[calc(100%+2px)]">
                        {filteredItems.map((item) => (
                            <div
                                key={item.id}
                                className="group w-full min-w-0 md:w-1/2 lg:w-1/3 border-t-0 border-b-2 border-ct-primary cursor-pointer flex flex-col border-l-2 border-r-0 md:odd:border-r-2 md:even:border-l-0 lg:[&:nth-child(3n+1)]:border-l-2 lg:[&:nth-child(3n+1)]:border-r-2 lg:[&:nth-child(3n+2)]:border-l-0 lg:[&:nth-child(3n+2)]:border-r-2 lg:[&:nth-child(3n)]:border-l-0 lg:[&:nth-child(3n)]:border-r-0"
                                onClick={() =>
